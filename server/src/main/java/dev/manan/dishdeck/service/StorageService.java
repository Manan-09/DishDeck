...
public class StorageService {
    ...
    private final long expirytme = 5*60*1000;
    ...
    public URL generatePresignedUrl(String key) throws Exception {
        try {
            final Date expirationDate = new Date(System.currentTimeMillis() + expirytme);
